...
import org.openedx.course.presentation.unit.pdf.PdfUnitViewModel
...
val screenModule = module {
    ...
    viewModel { (courseId: String?, infoType: String?, email: String?, name: String?, token: String?) ->
        VsSignUpViewModel(
            get(),
            get(),
            get(),
    ...
    factory { org.openedx.course.domain.interactor.LeaderboardInteractor(get()) }

    factory { org.openedx.course.domain.interactor.CourseRegistrationInteractor(get()) }

    viewModel { (courseId: String, formId: String) ->
        org.openedx.course.presentation.registration.CourseRegistrationViewModel(courseId, formId, get(), get(), get(), get())
    }
