...
interface OtpApi {
    ...
    @POST("/otp/send/")
    suspend fun sendSignUpOtp(@Body body: OtpSendRequest): Response<OtpSendResponse>
    ...
    @POST("/otp/resend/")
    suspend fun resendSignUpOtp(@Body body: OtpSendRequest): Response<OtpSendResponse>

    // 4.4 Login page, Send OTP
    @POST("/otp/login/send/")
    suspend fun sendLoginOtp(@Body body: OtpSendRequest): Response<OtpSendResponse>

    // 4.5 Login page, resend OTP
    @POST("/otp/login/resend/")
    suspend fun resendLoginOtp(@Body body: OtpSendRequest): Response<OtpSendResponse>

    // 4.7 Login with OTP
    @Headers("content-type: application/json")
    @POST("/otp/login/")
    suspend fun loginWithOtp(@Body body: OtpLoginRequest): Response<AuthResponse>
}
